...
class GatewayAkeneoOauthStatesGetResponse200HydraViewNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gyroscops\Api\Model\GatewayAkeneoOauthStatesGetResponse200HydraView::class;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && $data::class === \Gyroscops\Api\Model\GatewayAkeneoOauthStatesGetResponse200HydraView::class;
    }
