...
class AuthenticationWorkspacesGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\AuthenticationWorkspacesGetResponse200HydraSearch' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Gyroscops\\Api\\Model\\AuthenticationWorkspacesGetResponse200HydraSearch' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('hydra:mapping', $data) && null !== $data['hydra:mapping']) {
            ...
            foreach ($data['hydra:mapping'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Gyroscops\\Api\\Model\\AuthenticationWorkspacesGetResponse200HydraSearchHydraMappingItem', 'json', $context);
            }
