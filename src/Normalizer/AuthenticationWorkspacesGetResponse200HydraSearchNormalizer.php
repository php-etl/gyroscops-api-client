...
class AuthenticationWorkspacesGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\AuthenticationWorkspacesGetResponse200HydraSearch';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\AuthenticationWorkspacesGetResponse200HydraSearch';
    }
    /**
     * @return mixed
     */
