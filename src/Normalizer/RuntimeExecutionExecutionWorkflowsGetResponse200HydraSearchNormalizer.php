...
class RuntimeExecutionExecutionWorkflowsGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gyroscops\Api\Model\RuntimeExecutionExecutionWorkflowsGetResponse200HydraSearch::class;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && $data::class === \Gyroscops\Api\Model\RuntimeExecutionExecutionWorkflowsGetResponse200HydraSearch::class;
    }
