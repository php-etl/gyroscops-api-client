...
class ScheduleDeclarePipelineScheduleImmediateCommandJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleImmediateCommandJsonld';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleImmediateCommandJsonld';
    }
    /**
     * @return mixed
     */
