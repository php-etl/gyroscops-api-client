...
class EnvironmentSecretIdPutPutResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\EnvironmentSecretIdPutPutResponse200HydraSearch';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\EnvironmentSecretIdPutPutResponse200HydraSearch';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Gyroscops\Api\Model\EnvironmentSecretIdPutPutResponse200HydraSearch();
        ...
        if (\array_key_exists('hydra:mapping', $data)) {
            ...
            foreach ($data['hydra:mapping'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Gyroscops\\Api\\Model\\EnvironmentSecretIdPutPutResponse200HydraSearchHydraMappingItem', 'json', $context);
            }
