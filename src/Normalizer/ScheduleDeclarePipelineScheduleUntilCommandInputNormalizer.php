...
class ScheduleDeclarePipelineScheduleUntilCommandInputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleUntilCommandInput';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleUntilCommandInput';
    }
    /**
     * @return mixed
     */
