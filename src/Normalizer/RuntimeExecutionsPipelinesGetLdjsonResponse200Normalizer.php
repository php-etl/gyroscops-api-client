...
class RuntimeExecutionsPipelinesGetLdjsonResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\RuntimeExecutionsPipelinesGetLdjsonResponse200';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\RuntimeExecutionsPipelinesGetLdjsonResponse200';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\RuntimeExecutionsPipelinesGetLdjsonResponse200();
        ...
        if (\array_key_exists('hydra:view', $data) && $data['hydra:view'] !== null) {
            $object->setHydraView($this->denormalizer->denormalize($data['hydra:view'], 'Gyroscops\\Api\\Model\\RuntimeExecutionsPipelinesGetLdjsonResponse200HydraView', 'json', $context));
        ...
        if (\array_key_exists('hydra:search', $data) && $data['hydra:search'] !== null) {
            $object->setHydraSearch($this->denormalizer->denormalize($data['hydra:search'], 'Gyroscops\\Api\\Model\\RuntimeExecutionsPipelinesGetLdjsonResponse200HydraSearch', 'json', $context));
