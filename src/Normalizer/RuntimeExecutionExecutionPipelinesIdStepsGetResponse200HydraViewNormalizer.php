...
class RuntimeExecutionExecutionPipelinesIdStepsGetResponse200HydraViewNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\RuntimeExecutionExecutionPipelinesIdStepsGetResponse200HydraView' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return \is_object($data) && 'Gyroscops\\Api\\Model\\RuntimeExecutionExecutionPipelinesIdStepsGetResponse200HydraView' === $data::class;
    }
