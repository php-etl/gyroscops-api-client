...
class PipelineStepAddAfterPipelineStepCommandInputJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\PipelineStepAddAfterPipelineStepCommandInputJsonld';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\PipelineStepAddAfterPipelineStepCommandInputJsonld';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Gyroscops\Api\Model\PipelineStepAddAfterPipelineStepCommandInputJsonld();
