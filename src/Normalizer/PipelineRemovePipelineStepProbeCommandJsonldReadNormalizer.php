...
class PipelineRemovePipelineStepProbeCommandJsonldReadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\PipelineRemovePipelineStepProbeCommandJsonldRead' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Gyroscops\\Api\\Model\\PipelineRemovePipelineStepProbeCommandJsonldRead' === get_class($data);
    }
