...
class ScheduleDeclarePipelineScheduleOnceCommandInputJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleOnceCommandInputJsonld';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleOnceCommandInputJsonld';
    }
    /**
     * @return mixed
     */
