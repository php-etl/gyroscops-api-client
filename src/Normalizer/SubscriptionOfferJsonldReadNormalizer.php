...
class SubscriptionOfferJsonldReadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\SubscriptionOfferJsonldRead';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\SubscriptionOfferJsonldRead';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\SubscriptionOfferJsonldRead();
        ...
        if (\array_key_exists('color', $data) && $data['color'] !== null) {
            $object->setColor($this->denormalizer->denormalize($data['color'], 'Gyroscops\\Api\\Model\\ColorJsonldRead', 'json', $context));
            unset($data['color']);
        ...
        if (\array_key_exists('priceList', $data) && $data['priceList'] !== null) {
            ...
            foreach ($data['priceList'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Gyroscops\\Api\\Model\\PriceJsonldRead', 'json', $context);
            }
    ...
    {
        $data = [];
        $data['color'] = $this->normalizer->normalize($object->getColor(), 'json', $context);
