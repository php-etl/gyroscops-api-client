...
class AuthenticationOrganizationIdExternalCollaboratorsGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gyroscops\Api\Model\AuthenticationOrganizationIdExternalCollaboratorsGetResponse200HydraSearch::class;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && $data::class === \Gyroscops\Api\Model\AuthenticationOrganizationIdExternalCollaboratorsGetResponse200HydraSearch::class;
    }
