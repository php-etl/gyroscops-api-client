...
class JobJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\JobJsonld';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\JobJsonld';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\JobJsonld();
        ...
        if (\array_key_exists('pipeline', $data) && $data['pipeline'] !== null) {
            ...
            if (is_array($data['pipeline']) and isset($data['pipeline']['steps']) and isset($data['pipeline']['code'])) {
                $value = $this->denormalizer->denormalize($data['pipeline'], 'Gyroscops\\Api\\Model\\PipelineJsonld', 'json', $context);
            }
        ...
        if (\array_key_exists('action', $data) && $data['action'] !== null) {
            ...
            if (is_array($data['action']) and isset($data['action']['configuration'])) {
                $value_1 = $this->denormalizer->denormalize($data['action'], 'Gyroscops\\Api\\Model\\ActionJsonld', 'json', $context);
            }
