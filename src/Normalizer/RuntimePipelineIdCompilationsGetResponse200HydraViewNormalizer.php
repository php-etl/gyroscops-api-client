...
class RuntimePipelineIdCompilationsGetResponse200HydraViewNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\RuntimePipelineIdCompilationsGetResponse200HydraView' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Gyroscops\\Api\\Model\\RuntimePipelineIdCompilationsGetResponse200HydraView' === get_class($data);
    }
