...
class RegionJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\RegionJsonld';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\RegionJsonld';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\RegionJsonld();
        ...
        if (\array_key_exists('cloudEngine', $data) && $data['cloudEngine'] !== null) {
            $object->setCloudEngine($this->denormalizer->denormalize($data['cloudEngine'], 'Gyroscops\\Api\\Model\\AbstractCloudEngineJsonld', 'json', $context));
