...
class ScheduleDeclarePipelineScheduleOnceCommandNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleOnceCommand' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleOnceCommand' === get_class($data);
    }
