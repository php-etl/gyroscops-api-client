...
class RuntimeExecutionPipelineJobIdStepsGetResponse200HydraSearchHydraMappingItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\RuntimeExecutionPipelineJobIdStepsGetResponse200HydraSearchHydraMappingItem';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\RuntimeExecutionPipelineJobIdStepsGetResponse200HydraSearchHydraMappingItem';
    }
    /**
     * @return mixed
     */
