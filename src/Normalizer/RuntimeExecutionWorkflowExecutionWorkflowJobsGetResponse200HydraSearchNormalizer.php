...
class RuntimeExecutionWorkflowExecutionWorkflowJobsGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\RuntimeExecutionWorkflowExecutionWorkflowJobsGetResponse200HydraSearch' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Gyroscops\\Api\\Model\\RuntimeExecutionWorkflowExecutionWorkflowJobsGetResponse200HydraSearch' === get_class($data);
    }
