...
class GatewayAkeneoOauthTokenPutBodyHydraSearchHydraMappingItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gyroscops\Api\Model\GatewayAkeneoOauthTokenPutBodyHydraSearchHydraMappingItem::class;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && $data::class === \Gyroscops\Api\Model\GatewayAkeneoOauthTokenPutBodyHydraSearchHydraMappingItem::class;
    }
