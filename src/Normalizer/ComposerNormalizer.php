...
class ComposerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\Composer';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\Composer';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\Composer();
        ...
        if (\array_key_exists('autoloads', $data) && $data['autoloads'] !== null) {
            ...
            foreach ($data['autoloads'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Gyroscops\\Api\\Model\\ComposerAutoload', 'json', $context);
            }
        ...
        if (\array_key_exists('repositories', $data) && $data['repositories'] !== null) {
            ...
            foreach ($data['repositories'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Gyroscops\\Api\\Model\\ComposerRepository', 'json', $context);
            }
        ...
        if (\array_key_exists('authentications', $data) && $data['authentications'] !== null) {
            ...
            foreach ($data['authentications'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Gyroscops\\Api\\Model\\ComposerAuthentication', 'json', $context);
            }
