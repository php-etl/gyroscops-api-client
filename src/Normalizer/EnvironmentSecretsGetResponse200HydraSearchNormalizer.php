...
class EnvironmentSecretsGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\EnvironmentSecretsGetResponse200HydraSearch' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Gyroscops\\Api\\Model\\EnvironmentSecretsGetResponse200HydraSearch' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('hydra:mapping', $data) && null !== $data['hydra:mapping']) {
            ...
            foreach ($data['hydra:mapping'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Gyroscops\\Api\\Model\\EnvironmentSecretsGetResponse200HydraSearchHydraMappingItem', 'json', $context);
            }
