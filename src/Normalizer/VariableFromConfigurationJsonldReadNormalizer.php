...
class VariableFromConfigurationJsonldReadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\VariableFromConfigurationJsonldRead';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\VariableFromConfigurationJsonldRead';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('configuration', $data) && $data['configuration'] !== null) {
            ...
            if (is_array($data['configuration'])) {
                $value = $this->denormalizer->denormalize($data['configuration'], 'Gyroscops\\Api\\Model\\ConfigurationJsonldRead', 'json', $context);
            }
        ...
        if (\array_key_exists('environment', $data) && $data['environment'] !== null) {
            ...
            if (is_array($data['environment'])) {
                $value_1 = $this->denormalizer->denormalize($data['environment'], 'Gyroscops\\Api\\Model\\EnvironmentJsonldRead', 'json', $context);
            }
