...
class GatewayAkeneoOauthStatesGetResponse200HydraSearchHydraMappingItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\GatewayAkeneoOauthStatesGetResponse200HydraSearchHydraMappingItem' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Gyroscops\\Api\\Model\\GatewayAkeneoOauthStatesGetResponse200HydraSearchHydraMappingItem' === get_class($data);
    }
