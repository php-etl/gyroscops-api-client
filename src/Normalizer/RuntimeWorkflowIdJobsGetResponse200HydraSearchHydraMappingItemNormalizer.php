...
class RuntimeWorkflowIdJobsGetResponse200HydraSearchHydraMappingItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gyroscops\Api\Model\RuntimeWorkflowIdJobsGetResponse200HydraSearchHydraMappingItem::class;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && $data::class === \Gyroscops\Api\Model\RuntimeWorkflowIdJobsGetResponse200HydraSearchHydraMappingItem::class;
    }
