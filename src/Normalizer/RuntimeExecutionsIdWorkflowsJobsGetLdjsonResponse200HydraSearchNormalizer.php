...
class RuntimeExecutionsIdWorkflowsJobsGetLdjsonResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\RuntimeExecutionsIdWorkflowsJobsGetLdjsonResponse200HydraSearch';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\RuntimeExecutionsIdWorkflowsJobsGetLdjsonResponse200HydraSearch';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\RuntimeExecutionsIdWorkflowsJobsGetLdjsonResponse200HydraSearch();
        ...
        if (\array_key_exists('hydra:mapping', $data) && $data['hydra:mapping'] !== null) {
            ...
            foreach ($data['hydra:mapping'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Gyroscops\\Api\\Model\\RuntimeExecutionsIdWorkflowsJobsGetLdjsonResponse200HydraSearchHydraMappingItem', 'json', $context);
            }
