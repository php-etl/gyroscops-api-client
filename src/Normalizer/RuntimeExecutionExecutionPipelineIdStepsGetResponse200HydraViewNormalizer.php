...
class RuntimeExecutionExecutionPipelineIdStepsGetResponse200HydraViewNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\RuntimeExecutionExecutionPipelineIdStepsGetResponse200HydraView' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Gyroscops\\Api\\Model\\RuntimeExecutionExecutionPipelineIdStepsGetResponse200HydraView' === get_class($data);
    }
