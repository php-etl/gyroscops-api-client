...
class ScheduleDeclarePipelineScheduleUntilCommandNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleUntilCommand';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Api\\Model\\ScheduleDeclarePipelineScheduleUntilCommand';
    }
    /**
     * @return mixed
     */
