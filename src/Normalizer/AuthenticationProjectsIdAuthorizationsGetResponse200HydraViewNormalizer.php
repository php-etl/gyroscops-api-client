...
class AuthenticationProjectsIdAuthorizationsGetResponse200HydraViewNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Gyroscops\\Api\\Model\\AuthenticationProjectsIdAuthorizationsGetResponse200HydraView' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return \is_object($data) && 'Gyroscops\\Api\\Model\\AuthenticationProjectsIdAuthorizationsGetResponse200HydraView' === $data::class;
    }
