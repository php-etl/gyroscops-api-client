...
class PipelineStepAddBeforePipelineStepCommandJsonld
{
    /**
     * 
     *
     ...
     */
    public function getNext() : StepCodeJsonld
    {
        return $this->next;
    }
    /**
     * 
     *
     * @param StepCodeJsonld $next
     *
     * @return self
     */
    public function setNext(StepCodeJsonld $next) : self
    {
        $this->next = $next;
        return $this;
    }
