...
class PipelineStepReplacePipelineStepCommandJsonld
{
    /**
     * 
     *
     ...
     */
    public function getFormer() : StepCodeJsonld
    {
        return $this->former;
    }
    /**
     * 
     *
     * @param StepCodeJsonld $former
     *
     * @return self
     */
    public function setFormer(StepCodeJsonld $former) : self
    {
        $this->former = $former;
        return $this;
    }
