...
class ApiWorkspacesAuthorizationsGetSubresourceWorkspaceSubresource extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
     ...
     * {@inheritdoc}
     *
     * @return \Gyroscops\Api\Model\AuthenticationWorkspacesIdAuthorizationsGetLdjsonResponse200|\Gyroscops\Api\Model\UserAuthorization[]|null
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            if (mb_strpos($contentType, 'application/ld+json') !== false) {
                return $serializer->deserialize($body, 'Gyroscops\\Api\\Model\\AuthenticationWorkspacesIdAuthorizationsGetLdjsonResponse200', 'json');
            }
