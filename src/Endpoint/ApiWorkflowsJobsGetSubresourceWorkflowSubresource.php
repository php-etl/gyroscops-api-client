...
class ApiWorkflowsJobsGetSubresourceWorkflowSubresource extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{id}'], [$this->id], '/runtime/workflows/{id}/jobs');
    }
     ...
     * {@inheritdoc}
     *
     * @return \Gyroscops\Api\Model\RuntimeWorkflowsIdJobsGetLdjsonResponse200|\Gyroscops\Api\Model\WorkflowJobRead[]|null
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            if (mb_strpos($contentType, 'application/ld+json') !== false) {
                return $serializer->deserialize($body, 'Gyroscops\\Api\\Model\\RuntimeWorkflowsIdJobsGetLdjsonResponse200', 'json');
            }
