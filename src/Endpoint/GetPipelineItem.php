...
class GetPipelineItem extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
     ...
     * {@inheritdoc}
     *
     * @return \Gyroscops\Api\Model\PipelineJsonldRead|\Gyroscops\Api\Model\PipelineRead|null
     *
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            if (mb_strpos($contentType, 'application/ld+json') !== false) {
                return $serializer->deserialize($body, 'Gyroscops\\Api\\Model\\PipelineJsonldRead', 'json');
            }
        ...
        if (404 === $status) {
            throw new \Gyroscops\Api\Exception\GetPipelineItemNotFoundException($response);
        }
    }
