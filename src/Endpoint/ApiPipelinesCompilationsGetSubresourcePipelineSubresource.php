...
class ApiPipelinesCompilationsGetSubresourcePipelineSubresource extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
     ...
     * {@inheritdoc}
     *
     * @return \Gyroscops\Api\Model\RuntimePipelinesIdCompilationsGetLdjsonResponse200|\Gyroscops\Api\Model\Compilation[]|null
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            if (mb_strpos($contentType, 'application/ld+json') !== false) {
                return $serializer->deserialize($body, 'Gyroscops\\Api\\Model\\RuntimePipelinesIdCompilationsGetLdjsonResponse200', 'json');
            }
