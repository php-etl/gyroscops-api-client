...
class GetExecutionActionItem extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{id}'], [$this->id], '/runtime/executions/execution-actions/{id}');
    }
     ...
     * {@inheritdoc}
     *
     * @return \Gyroscops\Api\Model\ExecutionActionJsonld|\Gyroscops\Api\Model\ExecutionAction|null
     *
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            if (mb_strpos($contentType, 'application/ld+json') !== false) {
                return $serializer->deserialize($body, 'Gyroscops\\Api\\Model\\ExecutionActionJsonld', 'json');
            }
        ...
        if (404 === $status) {
            throw new \Gyroscops\Api\Exception\GetExecutionActionItemNotFoundException($response);
        }
    }
