...
class ApiProjectsUsersGetSubresourceProjectSubresource extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
    protected $id;
    /**
    ...
    {
        return str_replace(array('{id}'), array($this->id), '/authentication/projects/{id}/users');
    }
